...
Most of these come down to network reality or how devdocs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

devdocs rate-limits like any public site. devdocs already paces
...
Where a surface is gated, devdocs reads a cookie or token you supply
...
`devdocs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what devdocs actually did
